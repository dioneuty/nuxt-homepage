  ...
  <div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
        <h2 class="text-xl font-semibold mb-4 dark:text-white">영어 학습 자료</h2>
      ...
      <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
        ...
        <p class="dark:text-gray-300">
          매일 30분씩 영어 공부를 하는 것이 효과적입니다. 듣기, 말하기, 읽기, 쓰기를 골고루 연습하세요.
        </p>
      </div>
    </div>
    ...
    <div class="mb-4 mt-6">
      <button @click="toggleReadingSection" class="bg-blue-500 text-white px-4 py-2 rounded">
        {{ isReadingSectionVisible ? '영어 읽기 숨기기' : '영어 읽기 보이기' }}
      </button>
    </div>
    
    <!-- 영어 읽기 섹션 -->
    <div v-if="isReadingSectionVisible" class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
      <h2 class="text-xl font-semibold mb-4 dark:text-white">영어 읽기 연습</h2>
      <div class="mb-4">
...
function speak(index) {
  ...
  utterance.lang = 'en-US' // Changed from 'ja-JP' to 'en-US'
...
definePageMeta({
  title: '영어 학습 - Dion',
  meta: [
    { name: 'description', content: 'Dion - 영어 학습 페이지' },
    { name: 'keywords', content: 'Dion, 영어, 학습, 외국어' }
  ]
})
</script>